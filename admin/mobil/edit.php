                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" value="<?= htmlspecialchars($hasil['no_plat']); ?>" name="no_plat" placeholder="Isi No Plat">
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Merk Mobil</label>
                                <input type="text" class="form-control col-sm-9" value="<?= htmlspecialchars($hasil['merk']); ?>" name="merk" placeholder="Isi Merk">
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Harga</label>
                                <input type="text" class="form-control col-sm-9" value="<?= htmlspecialchars($hasil['harga']); ?>" name="harga" placeholder="Isi Harga">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label class="col-sm-3">Deskripsi</label>
                                <input type="text" class="form-control col-sm-9" value="<?= htmlspecialchars($hasil['deskripsi']); ?>" name="deskripsi" placeholder="Isi Deskripsi">
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <img src="../../assets/image/<?php echo htmlspecialchars($hasil['gambar']); ?>" class="img-fluid" style="width:200px;">
                            </div>
