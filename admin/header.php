    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #333;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item <?php if($title_web == 'Daftar Travel'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/travel/travel.php">Daftar Travel</a>
                </li>
                <li class="nav-item <?php if($title_web == 'Daftar Tarif Travel'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/tujuan/tujuan.php">Daftar Tarif Travel</a>
                </li>
